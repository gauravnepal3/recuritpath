...
import { addComment, updateComment } from "@/actions/jobs"
...
export function EditComment({ userID, candidateID, jobID, timelineID, comment }: { userID: string, candidateID: string, jobID: string, timelineID: string, comment: string }) {
    ...
    function onSubmit(data: z.infer<typeof FormSchema>) {
        try {
            const promise = updateComment({ userID: userID, candidateID: candidateID, comment: data.comment, jobID: jobID, timelineID: timelineID })
            toast.promise(
